    ...
    if results.multi_hand_landmarks:
        for hand_landmark in results.multi_hand_landmarks:
            ...
            if all(finger_fold_status):
                ...
                cv2.inwrite("in_memory_disk.png", image)
                pyautogui.screenshot("straingh_to_disk.png")
                image = cv2.imread(straingh_to_disk.png)
                cv2.inshow("Captura de Tela", imutils.resize(image, width=600))
